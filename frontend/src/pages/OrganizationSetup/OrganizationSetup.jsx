...
const OrganizationSetup = () => {
  ...
  const handleDeptSubmit = (e) => {
    ...
    addDepartment(newDeptName, newDeptHead || '-', newDeptParent);
  ...
  const handleEmpSubmit = (e) => {
    ...
    const res = addEmployee(newEmpName, newEmpEmail, newEmpRole, newEmpDept);
    if (res.success) {
  ...
  const handleRolePromotion = (empId, newRole, empName) => {
    const res = promoteUser(empId, newRole);
    if (res.success) {
  ...
  const handleDeactivate = (empId, empName) => {
    const res = deactivateEmployee(empId);
    if (res.success) {
    ...
    <div className="org-setup-page">
      <div className="org-header-row">
        <div>
          ...
          <p className="page-subheading">Master data  everything else in the system depends on these.</p>
        </div>
          ...
          {activeTab === 'departments' && (
            <form onSubmit={handleDeptSubmit} className="org-inline-form">
              ...
              <div className="form-group">
                ...
                >
                  <option value=""> Assign head (optional) </option>
                  {usersList.map(u => (
              ...
              <div className="form-group">
                ...
                >
                  <option value="-"> Parent department (optional) </option>
                  {departments.map(d => (
          ...
          {activeTab === 'employees' && (
            <form onSubmit={handleEmpSubmit} className="org-inline-form">
              ...
              <div className="form-group">
                ...
                >
                  <option value=""> Select department </option>
                  {departments.map(d => (
                    <option key={d.id} value={d.name}>{d.name}</option>
                  ))}
                </select>
...
export default OrganizationSetup;
>>>>>>> 10c09149142baf4187e54802525760fd01a985ee
